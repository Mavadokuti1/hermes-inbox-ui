import { MessageSquarePlus, MessageSquare, Trash2, Settings, Zap } from 'lucide-react'

// Left sidebar: brand, New Chat button, session list, settings entry.
    ...
    <aside className="flex h-full w-72 shrink-0 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="flex items-center gap-2 px-4 py-4">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-semibold text-gray-900">Hermes Inbox</span>
      ...
      <div className="px-3">
        <button
          onClick={onNew}
          className="flex w-full items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-700"
        >
