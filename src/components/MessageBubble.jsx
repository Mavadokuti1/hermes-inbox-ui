...
// right; assistant messages are dark panel bubbles aligned left, preceded by a
          ...
          <div
            className={`break-words rounded-2xl px-4 py-2.5 text-[15px] leading-relaxed ${
              isUser
                ...
                : error
                  ? 'whitespace-pre-wrap rounded-tl-sm border border-red-500/30 bg-red-500/10 text-red-300'
